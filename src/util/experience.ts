type SoulTier = {
    ...
    tierColor: string;
    tierQuote: string;
    friendlyTierName?: string | undefined;
    friendlyTierQuote?: string | undefined;
}
...
const soulTiers = [
    ...
    { level: 10, xp: 130, tierName: 'Short-Changed Soul Fetcher', tierColor: '#FFFFFF', tierQuote: '' },
    ...
    { level: 18, xp: 503, tierName: 'Tippling Soul Fetcher', tierColor: '#FFFFFF', tierQuote: 'Thankfully I already don\'t remember this...' },
    { level: 19, xp: 555, tierName: 'Incomprehensible Soul Fetcher', tierColor: '#FFFFFF', tierQuote: 'Everyone thinks I\'m just a one-eyed bloody monster' },
    { level: 20, xp: 619, tierName: 'Controverted Soul Fetcher', tierColor: '#FFFFFF', tierQuote: '' },
    { level: 21, xp: 666, tierName: '"Hell\'s Janitor"', tierColor: '#FFFFFF', tierQuote: '', friendlyTierName: 'Heck\'s Janitor' },
    { level: 22, xp: 777, tierName: 'Shit-Out-of-Luck Soul Fetcher', tierColor: '#FFFFFF', tierQuote: '', friendlyTierName: 'Crap-Out-of-Luck Soul Fetcher' },
    { level: 23, xp: 808, tierName: 'Bumping Soul Fetcher', tierColor: '#FFFFFF', tierQuote: '' },
    { level: 24, xp: 913, tierName: 'Meritorious Soul Fetcher', tierColor: '#FFFFFF', tierQuote: '' },
    { level: 25, xp: 1013, tierName: 'Eldritch Soul Fetcher', tierColor: '#FFFFFF', tierQuote: '\'Snerdler garloid?\' What is this cockamamie bullshit?', friendlyTierQuote: '\'Snerdler garloid?\' What is this cockneeyed business?' },
    { level: 26, xp: 1111, tierName: 'Psychotic Soul Fetcher', tierColor: '#FFFFFF', tierQuote: 'Make a wish!' },
    { level: 27, xp: 1223, tierName: 'Illiterate Soul Fetcher', tierColor: '#FFFFFF', tierQuote: 'Fail me twice... can\'t get failed again!' },
    ...
    { level: 31, xp: 1618, tierName: 'Dynastic Soul Fetcher', tierColor: '#FFFFFF', tierQuote: '' },
    { level: 32, xp: 1666, tierName: '"Hell\'s Jerome"', tierColor: '#FFFFFF', tierQuote: '', friendlyTierName: 'Heck\'s Jerome' },
    { level: 33, xp: 1692, tierName: 'Bewitched Soul Fetcher', tierColor: '#FFFFFF', tierQuote: '' },
    { level: 34, xp: 1777, tierName: 'Serendipitous Soul Fetcher', tierColor: '#FFFFFF', tierQuote: '' },
    { level: 35, xp: 1863, tierName: 'Bloodied Soul Fetcher', tierColor: '#FFFFFF', tierQuote: '' },
    { level: 36, xp: 1914, tierName: '"The Dead"', tierColor: '#FFFFFF', tierQuote: '' },
...
export const getSoulTier = (xp: number): SoulTier => {
...
export const getLevelUps = (oldXP: number, newXP: number) => {
    const oldSoulTier = getSoulTier(oldXP);
    const newSoulTier = getSoulTier(newXP);
